            ...
            try {
                ...
                Runnable myRunnable = new Runnable() {
                    ...
                    public void run() {
                        ...
                        Api.post("/login", rp, new JsonHttpResponseHandler() {
                            @Override
                            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                                ...
                                try {
                                    ...
                                    Log.d("onSuccess", "onSuccess: "+serverResp.get("user"));
                                    SharedPreferences.Editor editor = sharedpreferences.edit();
                                    editor.putString("User", serverResp.toString());
                                    editor.commit();
...
//                                System.out.println(responseString + " " + throwable.getCause());
                                showProgress(false);
                                mPasswordView.setError(getString(R.string.error_wrong_email_password_combination));
                                mPasswordView.requestFocus();
                            }
                        });
                    }
